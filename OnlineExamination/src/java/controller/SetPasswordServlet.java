 ...
 * @author cphuo
 */
@WebServlet(name="SetPasswordServlet", urlPatterns={"/SetPasswordServlet"})
public class SetPasswordServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        if (password_raw.equals(confirmPassword)) {
            ...
            dao.updateAccountPassword(a, password);
            request.setAttribute("successMsg", "Mật khẩu đã được thay đổi thành công!");
