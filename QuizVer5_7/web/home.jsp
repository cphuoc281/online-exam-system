            ...
            <div class="container">
                <div class="row g-5">
                    ...
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                        ...
                        <h1 class="mb-4">Welcome to ExamCheck</h1>
                        <p class="mb-4">With ExamCheck, you can embark on an exciting educational journey where knowledge meets convenience.</p>
            ...
            <div class="container py-5">
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <p class="mb-2"><i class="fa fa-envelope me-3"></i>ExamCheck@gmail.com</p>
